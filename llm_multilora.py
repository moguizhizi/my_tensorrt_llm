...
def main():
    ...
    lora_dir1 = snapshot_download(repo_id="snshrivas10/sft-tiny-chatbot", local_dir="/data/llm_lora/huggingface/snshrivas10/sft-tiny-chatbot/")
    ...
    lora_dir3 = snapshot_download(repo_id="barissglc/tinyllama-tarot-v1", local_dir="/data/llm_lora/huggingface/barissglc/tinyllama-tarot-v1")
